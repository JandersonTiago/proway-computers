// Definindo uma interface para representar um produto
export interface IProduto {
    id: number; // ID único do produto
    descricao: string; // Descrição do produto
    preco: number; // Preço do produto
    descricaoPreco: string; // Descrição detalhada do preço do produto
    quantidadeEstoque: number; // Quantidade disponível em estoque do produto
    imagem: string; // Caminho para a imagem do produto
}

// Definindo uma interface que estende a interface IProduto para representar produtos no carrinho de compras
export interface IProdutoCarrinho extends IProduto {
    quantidade: number; // Quantidade do produto no carrinho
}

// Definindo uma matriz de objetos que representam diferentes produtos
export const produtos: IProduto[] = [
    // Cada objeto representa um produto com seus respectivos atributos
